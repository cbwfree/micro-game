...
import (
	...
	"github.com/cbwfree/micro-game/example/game/protocol"
	server "github.com/cbwfree/micro-game/example/game/rpc"
...
func main() {
	app.New(def.SrvGameName, def.Version, mgo.Flags, rds.Flags)
	...
	// 注册RPC服务
	app.AddHandler(
		new(server.Forward), // 注册转发服务 (处理网关消息)
	)
